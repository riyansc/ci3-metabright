...
<!-- Page Heading -->
  ...
  <?php echo form_open_multipart('course/coursetambah');?>
    <div class="form-group row">
      <div class="col-lg-2">Course</div>
      <div class="col-lg-10">
        <input type="text" class="form-control" name="judul" id="judul" placeholder="Course Name">
    ...
    <div class="form-group row">
      ...
      <div class="col-lg-10">
        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control" placeholder="Deskripsi Course"></textarea>
    ...
    <div class="form-group row">
      ...
      <div class="col-lg-4">
          <input type="text" class="form-control" name="harga" id="harga" value="Rp.">
