...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'metabrigth.id@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Metabright.id'; // Isikan dengan nama pengirim
    protected $password = 'juiuofadxruvrdcf'; // Isikan dengan password email pengirim
    ...
    public function send($data){
        ...
        $mail->addAddress($data['email'], ''); //Alamat Email penerima
